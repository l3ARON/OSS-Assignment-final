  ...
  return (
    <div className="container">
      ...
      <table>
        <tr>
          <td className="table_cell_foot">
            ...
            <ul>
              <li>불충분한 식량 접근성을 측정하는 지표</li>
              <li>어린이와 성인을 포함한 전체 인구를 지칭</li>
              <li>국제적인 기아 목표를 위한 주요 지표로 사용</li>
            </ul>
          </td>
          <td className="table_cell_foot">
            <strong>Child stunting & Child wasting</strong><br />
            <ul>
              <li>식단의 질과 활용 측면을 고려</li>
              <li>어린이의 영양 결핍에 대한 취약성을 반영</li>
              <li>지속가능발전목표를 위한 영양 지표로 사용</li>
            </ul>
          </td>
          <td className="table_cell_foot">
            <strong>Child mortality</strong><br />
            <ul>
              <li>굶주림에 어린이가 가장 취약하다는 점 반영</li>
              <li>발육부진과 소모증은 영양실조로 인한 사망 위험을 부분적으로만 반영</li>
            </ul>
          </td>
        </tr>
      </table>
      ...
      <div className='lastExplain'>
        ...
        <p> 
          <p>
            기아 문제는 매우 복잡하며, 이를 설명하기 위해 다양한 용어가 사용됩니다. 기아는 일반적으로 충분한 칼로리를 섭취하지 못해 발생하는 고통을 의미합니다. 
            유엔 식량농업기구(FAO)는 식량 부족 또는 영양부족을 개인이 건강하고 생산적인 삶을 유지하기 위해 필요한 최소한의 에너지를 제공받지 못하는 상태로 정의합니다. 
            이는 성별, 나이, 신장, 신체 활동 수준에 따라 다르게 나타날 수 있습니다.
          </p>

          <p>
            <strong>영양실조</strong>는 칼로리 부족을 넘어 에너지, 단백질, 필수 비타민과 미네랄의 결핍을 포함합니다. 
            이는 음식의 양이나 질이 부족하거나, 감염이나 질병으로 인해 체내에서 영양소를 제대로 활용하지 못하는 경우에 발생합니다. 
            또한, 가정 내 식량 불안정, 부적절한 모성 건강 관리와 육아 방식, 안전한 물과 위생 시설 부족, 의료 서비스 접근성 부족 등 다양한 근본적인 요인에서 비롯됩니다.
          </p>

          <p>
            <strong>영양불균형</strong>은 영양실조와 과영양 모두를 포함합니다. 
            과영양은 과체중, 비만, 비전염성 질병을 초래하며, 이러한 문제는 전 세계적으로 점점 더 흔해지고 있습니다. 
            이는 개인의 건강뿐만 아니라 정부 지출, 식량 체계 발전에도 영향을 미칩니다.
          </p>

          <p>
            GHI(Global Hunger Index)는 과영양보다는 주로 영양실조와 관련된 문제에 초점을 맞추고 있으며, 기아를 설명하기 위해 다양한 용어와 개념이 사용됩니다.
          </p>
        </p>
        ...
        <ol>
          <li>이용 가능한 GHI 지표 값</li>
          <li>국가의 마지막으로 알려진 GHI 심각도</li>
          <li>국가의 마지막으로 알려진 영양부족 유병률</li>
          <li>해당 국가가 속한 아지역의 영양부족 유병률</li>
          <li>유엔 식량농업기구의 평가</li>
        </ol>
        <p>
